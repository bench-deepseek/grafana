...
func (cfg *Cfg) readSecretsManagerSettings() {
	...
	cfg.SecretsManagement.SecureValueMetadataCacheTTL = secretsMgmt.Key("secure_value_metadata_cache_ttl").MustDuration(5 * time.Minute)
	...
	cfg.SecretsManagement.SecureValueMetadataCacheRedisPrefix = secretsMgmt.Key("secure_value_metadata_cache_redis_prefix").MustString("gsm-svm")
